  ...
  return (
    <div className="min-h-screen bg-white text-slate-100 flex flex-col md:flex-row">
      ...
      <main className="flex-1 p-4 md:p-8 overflow-y-auto space-y-6">
        ...
        {/* Tab Toggle */}
        <div className="flex items-center gap-2 bg-white border border-[#dce9df] p-1.5 rounded-2xl">
          <button
          ...
          <div className="bg-white border border-[#dce9df] rounded-2xl p-6 shadow-xl space-y-4">
            ...
            <div className="space-y-3">
              {deliveryAddresses.map((addr) => (
                <div
                  key={addr.id}
                  className="p-4 rounded-2xl bg-white border border-[#dce9df] flex items-start justify-between text-xs space-y-1"
                >
                  <div>
