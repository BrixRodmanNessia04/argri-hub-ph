    ...
    <div className="min-h-screen bg-[#f6fbf7] text-[#163025] flex flex-col font-sans">
      <header className="h-16 bg-white border-b border-[#dce9df] px-4 sm:px-6 flex items-center justify-between sticky top-0 z-40 shadow-xs">
        <div className="flex items-center gap-3">
          <Link href={buildRoute("/finance")} className="flex items-center gap-2">
            ...
            <div>
              ...
              <span className="text-[10px] font-bold text-[#059669] block -mt-1">Agri-Credit &amp; Insurance</span>
            </div>
          </Link>
        </div>
      ...
      <div className="flex-1 flex">
        <aside className="w-64 bg-white border-r border-[#dce9df] hidden lg:flex flex-col p-5 shrink-0 min-h-[calc(100vh-64px)] sticky top-16">
          <div className="space-y-4">
            <h2 className="text-[10px] uppercase font-black text-[#059669] tracking-wider">Credit &amp; Insurance</h2>
            <nav className="space-y-1">
              <Link href={buildRoute("/finance")} className="flex items-center gap-3 px-3.5 py-2.5 rounded-xl text-xs font-bold bg-[#059669] text-white shadow-xs">
