...
import { Coins, ShieldCheck, CreditCard, Menu, X } from "lucide-react";
        ...
        <div className="flex items-center gap-3">
          ...
          <Link href="/finance" className="flex items-center gap-2">
            ...
            <div>
              ...
              <span className="text-[10px] font-bold text-emerald-400 block -mt-1">Agri-Credit &amp; Insurance</span>
            </div>
          </Link>
        </div>

        <span className="px-2.5 py-0.5 rounded-full bg-emerald-950 text-emerald-400 border border-emerald-800 text-[10px] font-extrabold">
          FINANCE PORTAL
        </span>
      </header>
